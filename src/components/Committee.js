        ...
        <div className="grid grid-flow-row grid-cols-2 gap-x-20 px-40 py-40 ">

          {
            commitiedata.map((item, index) => {
              return (
                item.type == "member" ?
                  <div className="bg-white text-black transition-all duration-500 hover:scale-105 rounded-full text-center py-5">
                     <h1 className="text-3xl font-semibold">{item.name}</h1>
                     <h2 className="py-1">{item.position}</h2>
                     <button className=" w-[200px] py-2 bg-black border-none  text-white  rounded-2xl">
