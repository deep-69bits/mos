  ...
  return (
    <div className='text-white min-h-screen bg-[#02062a] w-full'>
      <ReactSimplyCarousel
        ...
        easing="linear"
      >
       <div className='h-screen w-[1500px] text-center'>
       <h1 className="text-center block float-right absolute m-8 ">
       <span className="text-5xl">{date.toLocaleTimeString()}</span>
       <br />
       <span>
      ...
      <h1 className='text-3xl py-10 font-semibold'> Timings </h1>
      <div className=" m-auto scale-130 w-fit">
      ...
      <div className="flex m-10 gap-4">
            ...
            if (item.type === "event") {
              return (
                <div className='h-screen w-[1500px] text-center'>
                  ...
                  <h1 className='text-3xl font-bold py-10'>{item.NameOfEvent}</h1>
                  <img className='m-auto rounded-xl' src={item.image} alt="" />
        ...
        }
        {
          dataa.map((item, index) => {
            if (item.type === "hadid") {
              return (
                <div className='h-screen  w-[1500px] text-center   text-xl '>
                  <h1 className="text-center block float-right absolute m-8 ">
                    <span className="text-5xl">{date.toLocaleTimeString()}</span>
                    <br />
                    <span>
                  ...
                  <h1 className='text-3xl py-10 font-semibold'>Hadid</h1>
                  <h2 className='text-4xl transition-all duration-500 hover:scale-105 rounded-lg bg-white text-black py-20 my-10 px-10 '>
                    {item.hadid}
                  </h2>
                </div>
              )
        ...
        <div className='h-screen w-[1500px] text-center text-xl px-40 '>
          <h1 className="text-center block float-right absolute m-8 ">
            <span className="text-5xl">{date.toLocaleTimeString()}</span>
            <br />
            <span>
          ...
          <h1 className='text-3xl py-10 font-semibold'>Member</h1>
